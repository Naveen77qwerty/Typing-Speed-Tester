...
public class WordGenerator {
    ...
    private void initializeWords() {
        // Directly initialize words collection with words from words.txt
        String[] commonWords = {
    ...
    public String getRandomSentence() {
        ...
        switch (currentDifficulty) {
            case EASY:
                ...
                break;
            case HARD:
                sentenceLength = 10 + random.nextInt(6); // 10-15 words
                break;
            default: // MEDIUM
                sentenceLength = 7 + random.nextInt(4); // 7-10 words
                break;
        }
